        ...
        <div class="col-md-8">
           ...
           <form action="<?php echo e(route('add.cart',$product->slug)); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" name="qty" id="qty"   max="<?php echo e($product->qty); ?>" min="1" class="from-control">
            </div>
            <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\CodeTests\e-project\resources\views/products/show.blade.php ENDPATH**/ ?>